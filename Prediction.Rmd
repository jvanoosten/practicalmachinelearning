...
The RandomeForest algorithm is used to create the model.  All of sensor based columns are used as predictors.   The doMC package is used to exploit the multiple cores on my work station during the model creation.  It forks processes to split computations and run in a fraction of the time versus a single core execution.
...
A plot of the model shows most of the accuracy is achieved with a few predictors and a slit improvement is achieved with less then 30 predictors.
