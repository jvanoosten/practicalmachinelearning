...
In addition, I removed user_name, time stamps, and window columns as predictors so the model would be based solely on the sensor data.  The names of the remaining variables are shown.
